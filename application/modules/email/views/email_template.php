...
<head>
    ...
    <!-- <![endif]-->
    <title>GC&C Inventory System V1.0</title>
    <style type="text/css">
        body {
            width: 100%;
                            ...
                            <table border="0" align="center" width="980" cellpadding="0" cellspacing="0" class="container980">
								<tr>
                                    <td align="center" height="70" style="color: #343434; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; text-align: center;">
										<h1 align="center">Inventory System - <?php echo $this->email_template->getCoreSetup()["site_name"];?></h1>
                    ...
                    <tbody>
						...
						<tr>
							<td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
								<div style="line-height: 24px">Inventory check as of <?php echo (isset($date) && $date)? date("F d, Y", strtotime($date)): date("F d, Y"); ?></div>
							</td>
						</tr>
						<tr>
                ...
                <table align="center" border="0" width="980" cellpadding="0" cellspacing="0" bgcolor="ffffff">
                    ...
                    <thead>
                        <tr class="cleared-items">
                            <td colspan="5">
                                <h4 style="background-color: #efefef; padding: 10px 5px; font-weight: bold; font-family: Quicksand, Calibri, sans-serif; text-align: center; margin-bottom: 10px;"><?php echo isset($email_title) ? $email_title : ""; ?></h4>
                            </td>
                        </tr>
                        <tr>
                            <th align="left" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 35px; margin-bottom: 10px;">STOCK CODE</th>
                            ...
                            <th align="left" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 35px; margin-bottom: 10px;">CATEGORY</th>
                            <th align="left" style="color: #343434; font-size: 14px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 0px; line-height: 35px; margin-bottom: 10px;">PRIORITY</th>
                        </tr>
                   </thead>
                   <tbody>
                        ...
                        <tr>
                            <td align="left" width="180" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                ...
                                <?php echo strtoupper($_data["sku"]); ?>
                            </td>    
                            <td align="left" width="450" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                 <?php echo strtoupper($_data["name"]); ?>
                            </td>    
                            <td align="left" width="160" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                <?php echo strtoupper($_data["c_name"]); ?>
                            </td>    
                            <td align="left" width="105" v-align="top" style="vertical-align: text-top; color: #343434; font-size: 14px; font-family: 
                                'Work Sans', Calibri, sans-serif; line-height: 18px; font-weight: 500;">
                                 <?php echo strtoupper($_data["p_name"]); ?>
                            </td>       
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>
                                ...
                                <tr>
                                    <td align="left" style="color: #333333; font-size: 13px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            <span style="color: #333333;">GC&amp;C Inventory System</span>
                                        </div> 
                                    </td>
                                </tr>
                            </table>
