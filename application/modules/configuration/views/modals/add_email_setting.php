<div class="modal fade" tabindex="-1" role="dialog"
     id="add-email-setting-modal">
    <form action="" id="frm-add-email-setting-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Email Setting</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger btnSave" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </form>
